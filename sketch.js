...
function setup(){
   ...
   // ellipse(polygon.position.x,polygon.position.y,20);
    ...
    b8 = new box(320,400,30,30);
    b9 = new box(330,400,30,30);
    b10 = new box(340,400,30,30);
    b11 = new box(350,400,30,30);
    b12 = new box(360,400,30,30);
    b13 = new box(330,410,30,30);
    b14 = new box(340,410,30,30);
    b15 = new box(350,410,30,30);
    b16 = new box(340,420,30,30);
    ...
    bl6 = new box(520,250,20,18);
    bl7 = new box(530,250,20,18);
    bl8 = new box(540,250,20,18);
    bl9 = new box(530,260,20,18);
